      ...
      <main className="font-sans">
        ...
        <SectionLayout>
          <div className="bg-blue-950 rounded-2xl overflow-hidden  p-8 relative isolate shadow-2xl">
            ...
            <p className="text-center text-4xl font-extrabold text-white max-w-md mx-auto">
 ...
 *
        <div>
          <section className="py-12 sm:py-16 lg:py-20 max-w-6xl mx-auto px-4 space-y-8">
            <p className="text-2xl text-stone-900 font-bold text-center md:text-3xl">Los Productos Favoritos</p>
            <div className="grid md:grid-cols-2 h-[1000px] md:h-[600px] gap-8">
              <div className="flex flex-col relative overflow-hidden h-full justify-end rounded-xl group">
                <img
                ...
                <div className="p-4 rounded-lg">
                  ...
                  <p className="text-xl md:text-2xl font-bold line-clamp-1 text-black">
              ...
              <div className="grid gap-8">
                <div className="flex flex-col relative overflow-hidden h-full justify-end rounded-xl group">
                  ...
                  />
                  <div className="inset-0 absolute to-stone-900/10 from-transparent -z-10 group-hover:to-stone-900/20 transition" />
                  <div className="p-4 rounded-lg">
                    <h3 className="text-sm">TVs</h3>
